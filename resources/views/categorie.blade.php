...
<div class="container">
    ...
    @foreach($categorie->sous_categories()->orderBy('slug')->get() as $ss_categ)
        ...
        <div class="row border-bottom mx-2 mb-2">
            <div class="col-8 col-md-10 text-left font-weight-bold">Intitulé</div>
            <div class="col-4 col-md-2 text-center font-weight-bold">Durée</div>
        </div>
        @foreach($ss_categ->formations()->orderBy('nom')->get() as $formation)
            <div class="row mx-2 my-2">
                ...
                <div class="col-4 col-md-2 text-center purple font-weight-bold">{{$formation->duree}}</div>
            </div>
        @endforeach
    @endforeach
</div>
